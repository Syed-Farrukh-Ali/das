...
class EmpSalaryDetailResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'salaryAlowance' => new SalaryAllowanceResource($this->salaryAllowance),
            'salaryDeduction' => new SalaryDeductionResource($this->salaryDeduction),
            'gp_collected_fund' => new GPFundResource($this->GPFund),
