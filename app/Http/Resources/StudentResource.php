...
class StudentResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'student_class_name' => $this->studentClass ? $this->studentClass->name : '',
            'admission_id' => $this->admission_id,
            'registration_id' => $this->registration_id,
            'global_section_id' => $this->global_section_id,
            'global_section_name' => $this->globalSection ? $this->globalSection->name : '',
            'name' => $this->name,
            ...
            'status' => $this->status,
            'monthly_fees' => $this->monthly_fees ?? 0,
            ...
            'fee_challans_detials' => FeeChallanDetailResource::collection($this->whenLoaded('feeChallanDetails')),
            'fee_return' => FeeReturnResource::collection($this->whenLoaded('fee_return')),
