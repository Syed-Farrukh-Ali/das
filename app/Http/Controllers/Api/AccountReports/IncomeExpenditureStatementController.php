...
use App\Http\Requests\Account\IncomeExpenditureRequest;
use App\Models\AccountGroup;
use App\Models\GeneralLedger;
use App\Models\SubAccount;

class IncomeExpenditureStatementController extends BaseController
{
    public function report(IncomeExpenditureRequest $request)
    {
        $account_groups = AccountGroup::whereIn('id',[8,9,10,11,12])->get();
