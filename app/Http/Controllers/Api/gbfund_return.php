...
class gbfund_return extends BaseController
{
   public function gbfund_return(Request $req){
return employee::with('GPFund')->with('employeeSalaries1')->where('emp_code',$req->emp_id)->get();
}
public function genrate_return(Request $req){
